...
def plots(history):
	...
	f1.savefig('/home/matthia/Desktop/MSc.-Thesis/Results/Figures/Relu/AccuracyPlotModel1_'+str(learning_r)+'.png')
	plt.close()
	...
	plt.xlabel('Epoch')
	plt.legend(['Training', 'Validation'], loc='upper left')
	f2.savefig('/home/matthia/Desktop/MSc.-Thesis/Results/Figures/Relu/LossPlotModel1_'+str(learning_r)+'.png')
	plt.close()
