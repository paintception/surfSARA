...
def plots(history):
	...
	f1.savefig('/home/matthia/Desktop/MSc.-Thesis/Results/Figures/Regression/Relu/AccuracyPlotModel1_'+str(learning_r)+'.png')
	plt.close()
	...
	plt.xlabel('Epoch')
	plt.legend(['Training', 'Validation'], loc='upper left')
	f2.savefig('/home/matthia/Desktop/MSc.-Thesis/Results/Figures/Regression/Relu/LossPlotModel1_'+str(learning_r)+'.png')
	plt.close()
...
def main():
	...
	for learning_r in learning_rates:
	    ...
	    print "Training for lr: ", learning_r
            ...
            model.save('KerasModels/Regression/Relu/Model1_'+str(learning_r)+'.h5')
            plots(history)
